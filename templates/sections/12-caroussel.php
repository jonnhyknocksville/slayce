            ...
            <div class="carousel-item <?php if ($first) { echo 'active'; $first = false; } ?>">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        ...
                        <a href="<?php echo htmlspecialchars($item['button_1_href']); ?>" class="btn btn-primary"><?php echo htmlspecialchars($item['button_1']); ?></a>
                        <a href="<?php echo htmlspecialchars($item['button_2_href']); ?>" class="btn btn-secondary ml-2"><?php echo htmlspecialchars($item['button_2']); ?></a>
                    </div>
                </div>
            </div>
            <?php
