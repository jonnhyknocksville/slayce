...
<div class="row col-md-8 mx-auto py-5">
    <!-- Section Header -->
    ...
    <div class="row align-items-center">
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                <div class="counters">
                    <div class="facts-item">
                        <div class="fact-count bg-light p-2">
        ...
        <div class="col-lg-4 col-md-12 p-0" data-aos="fade-right">
            <img src="images/<?= htmlspecialchars($config['presentation_img']); ?>" class="img-fluid rounded" alt="<?= htmlspecialchars($config['presentation_alt']); ?>">
        </div>
    </div>
